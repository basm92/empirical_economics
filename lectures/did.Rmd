...
$Y_{it} = \beta_0 + \beta_1Treat_i + \beta_2Post_t + \beta_3(Treat_i × Post_t) + \epsilon_{it}$
...
$$
Y_{it} = \beta_0 + \beta_1Treat_i + \beta_2Post_t + \beta_3(Treat_i × Post_t) + \gamma'X_{it} + \epsilon_{it}
$$
