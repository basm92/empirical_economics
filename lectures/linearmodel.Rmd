...
Of course. Here are a few slides on hypothesis testing in linear regression using t-tests and F-tests, formatted in RMarkdown.

---

## Hypothesis Testing in Regression

Once we've estimated our model, $\widehat{y} = \hat{\beta}_0 + \hat{\beta}_1 x$, we need to ask: **Is the relationship we found statistically significant?**

-   Our estimates $\hat{\beta}_0$ and $\hat{\beta}_1$ are based on a *sample* of data. They are subject to sampling variability.
